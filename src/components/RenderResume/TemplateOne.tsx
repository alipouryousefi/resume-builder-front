      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        >
          <div className="flex flex-col items-center px-2">
            <div
              className="w-[100px] h-[100px] rounded-full max-w-[110px] max-h-[110px] flex items-center justify-center"
            ...
            <h2 className="text-xl font-bold">{resume.profileInfo.fullName}</h2>
